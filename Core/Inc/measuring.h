...
#define FMCW_ADC_ZERO_PADDING 0 // zeroes before the signal
#define FMCW_FREQ_BIN_SIZE FMCW_ADC_SAMPLING_FREQ / (FMCW_ADC_SAMPLE_COUNT+FMCW_ADC_ZERO_PADDING)
...
#define DOPP_FREQ_BIN_SIZE (((float)DOPP_ADC_SAMPLING_FREQ) / ((float)DOPP_ADC_SAMPLE_COUNT))
